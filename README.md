...
<img src="piep_icon.svg" alt="piep" width="96" height="96">
...
- **守る** — ライブラリ全体のZIPバックアップと検証付き復元、保存フォルダーからの再取り込み、容量と索引の診断。
...
- 本ソフトウェアは無保証で提供されます。大切なライブラリは、設定画面のバックアップ機能で定期的に保存してください。
